...
| [**Research Flow Blueprint**](./RESEARCH_FLOW_BLUEPRINT.md) | Research: KB confidence, explainability, official-doc research, live updates; Tool Gateway (Tavily/MCP) | MD |
| [**Tool Gateway Design**](./TOOL_GATEWAY_DESIGN.md) | Standard framework for integrations (Tavily, Teams, WhatsApp, email); MCP + UTC | MD |
| [**Tool Extension Guide**](./TOOL_EXTENSION_GUIDE.md) | User guide: how to add tools via direct registration, MCP, or UTC | MD |
| [LLM Dataflow](./DATAFLOW_LLM.md) | How Chat uses KB + LLM for summarization | MD |
| [**Pydantic models**](./PYDANTIC_MODELS.md) | What Pydantic is and how we use it (ApplicationProfile, ResearchResult, etc.) | MD |
