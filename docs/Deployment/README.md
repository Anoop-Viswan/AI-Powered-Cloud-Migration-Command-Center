...
| [CI-Config-and-Rerun.md](CI-Config-and-Rerun.md) | How to re-run CI without a code change; where API keys (Secrets) and config like OPENAI_MODEL (Variables) come from. |
